...
export const FIXED_BOTS = [
  // ── Champion tier (500+ LP) ──────────────────────────────────────────────
  {
    ...
    elo: 1920, lp: 680, // xp: 14200, level: 28, leagueDivision: "champion",
  ...
  },
  {
    ...
    elo: 1780, lp: 620, // xp: 10800, level: 22, leagueDivision: "champion",
  ...
  },
  {
    ...
    elo: 2100, lp: 780, // xp: 21000, level: 42, leagueDivision: "champion",
  ...
  },
  {
    ...
    elo: 1850, lp: 560, // xp: 16000, level: 33, leagueDivision: "champion",
  ...
  },
  {
    ...
    elo: 1760, lp: 530, // xp: 12100, level: 26, leagueDivision: "champion",
  ...
  // ── Pro tier (300-499 LP) ────────────────────────────────────────────────
  {
    ...
    elo: 1490, lp: 445, // xp: 7200, level: 16, leagueDivision: "pro",
  ...
  },
  {
    ...
    elo: 1380, lp: 315, // xp: 4600, level: 11, leagueDivision: "pro",
  ...
  },
  {
    ...
    elo: 1555, lp: 395, // xp: 7100, level: 17, leagueDivision: "pro",
  ...
  },
  {
    ...
    elo: 1460, lp: 340, // xp: 5000, level: 13, leagueDivision: "pro",
  ...
  },
  {
    ...
    elo: 1610, lp: 465, // xp: 8800, level: 19, leagueDivision: "pro",
  ...
  },
  {
    ...
    elo: 1650, lp: 480, // xp: 8500, level: 18, leagueDivision: "pro",
  ...
  },
  {
    ...
    elo: 1540, lp: 420, // xp: 6900, level: 15, leagueDivision: "pro",
  ...
  },
  {
    ...
    elo: 1420, lp: 360, // xp: 5400, level: 12, leagueDivision: "pro",
  ...
  // ── Coin/Div2 tier (100-299 LP) ──────────────────────────────────────────
  {
    ...
    elo: 1310, lp: 280, // xp: 4000, level: 9, leagueDivision: "coin",
  ...
  },
  {
    ...
    elo: 1200, lp: 175, // xp: 2800, level: 7, leagueDivision: "coin",
  ...
  },
  {
    ...
    elo: 1260, lp: 240, // xp: 3500, level: 8, leagueDivision: "coin",
  ...
  },
  {
    ...
    elo: 1350, lp: 295, // xp: 3900, level: 9, leagueDivision: "coin",
  ...
  },
  {
    ...
    elo: 1180, lp: 145, // xp: 2300, level: 6, leagueDivision: "coin",
  ...
  },
  {
    ...
    elo: 1290, lp: 215, // xp: 3200, level: 8, leagueDivision: "coin",
  ...
  },
  {
    ...
    elo: 1225, lp: 165, // xp: 2600, level: 7, leagueDivision: "coin",
  ...
  },
  {
    ...
    elo: 1320, lp: 260, // xp: 3700, level: 9, leagueDivision: "coin",
  ...
  },
  {
    ...
    elo: 1165, lp: 120, // xp: 1900, level: 6, leagueDivision: "coin",
  ...
  },
  {
    ...
    elo: 1245, lp: 195, // xp: 3000, level: 7, leagueDivision: "coin",
  ...
  // ── Training tier (0-99 LP) ──────────────────────────────────────────────
  {
    ...
    elo: 1100, lp: 85, // xp: 1800, level: 5, leagueDivision: "training",
  ...
  },
  {
    ...
    elo: 1020, lp: 45, // xp: 900, level: 3, leagueDivision: "training",
  ...
  },
  {
    ...
    elo: 1050, lp: 65, // xp: 1400, level: 4, leagueDivision: "training",
  ...
  },
  {
    ...
    elo: 1010, lp: 30, // xp: 700, level: 2, leagueDivision: "training",
  ...
  },
  {
    ...
    elo: 1080, lp: 78, // xp: 1600, level: 4, leagueDivision: "training",
  ...
  },
  {
    ...
    elo: 1035, lp: 15, // xp: 500, level: 2, leagueDivision: "training",
  ...
  },
  {
    ...
    elo: 1060, lp: 55, // xp: 1200, level: 3, leagueDivision: "training",
  ...
  },
  {
    ...
    elo: 1015, lp: 8, // xp: 400, level: 1, leagueDivision: "training",
  ...
  },
  {
    ...
    elo: 1045, lp: 38, // xp: 1000, level: 3, leagueDivision: "training",
  ...
  },
  {
    ...
    elo: 1090, lp: 92, // xp: 1700, level: 5, leagueDivision: "training",
