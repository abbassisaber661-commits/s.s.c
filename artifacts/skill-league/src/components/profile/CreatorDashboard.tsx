...
export default function CreatorDashboard({
  ...
  return (
    <motion.div
      ...
      style={{
        background:
          "linear-gradient(160deg, rgba(15,8,35,0.97) 0%, rgba(20,12,50,0.97) 100%)",
        border: "1px solid rgba(167,139,250,0.18)",
        boxShadow: "0 0 60px rgba(124,58,237,0.1), 0 4px 30px rgba(0,0,0,0.4)",
      }}
    >
      {/* ── Header strip ─────────────────────────────────── */}
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, rgba(124,58,237,0.3) 0%, rgba(79,70,229,0.2) 100%)",
          borderBottom: "1px solid rgba(167,139,250,0.15)",
        }}
      >
        <span className="text-base">💎</span>
        <p className="text-white font-black text-sm tracking-wide">Creator Dashboard</p>
      ...
      <div className="p-4 flex flex-col gap-5">
        ...
        <motion.div variants={item}>
          ...
          {/* Global rank */}
          <div className="flex items-center gap-3 rounded-2xl px-4 py-3 mb-2.5"
            style={{
          ...
          <div className="grid grid-cols-2 gap-2.5">
            ...
            <CountTile
              ...
              value={
                isLoading
                  ? "—"
                  : (giftStats?.totalGiftTransactions ?? 0).toLocaleString()
              }
              loading={isLoading}
              accent="#fb923c"
            />
