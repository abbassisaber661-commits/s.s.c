    ...
    <AnimatePresence>
      ...
      >
        <div className="flex items-center gap-2 min-w-0">
          ...
          <span className="text-muted-foreground/60 hidden md:inline">{t('beta_experimental')}</span>
        </div>
        ...
        <div className="flex items-center gap-2 shrink-0">
          {offline ? (
            <span className="flex items-center gap-1 text-amber-400">
              <WifiOff size={11} />
              <span className="hidden sm:inline">{t('beta_offline')}</span>
            </span>
          ) : (
            <span className="flex items-center gap-1 text-green-400">
              <Wifi size={11} />
              <span className="hidden sm:inline">{t('beta_online')}</span>
            </span>
          )}
          <Link href="/beta-dashboard">
            <button className="flex items-center gap-1 text-purple-400 hover:text-purple-300 transition-colors">
              <Bug size={12} />
              <span className="hidden sm:inline">{t('beta_dashboard')}</span>
