  ...
  return (
    <div className="min-h-screen pb-24" style={{ background: BG, color: "#050505" }}>
      ...
      <div className="max-w-md mx-auto px-4">
        ...
        {/* ── ACCOUNT UID ───────────────────────────────────────────────
            Removed from display for security (SSC hardening): the raw
            Pi Network UID must never be shown or copyable in the UI,
            even to the account's own owner. It remains stored server-side
            and continues to power internal auth/session logic unchanged.
        ──────────────────────────────────────────────────────────────── */}
