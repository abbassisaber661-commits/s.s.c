...
const LEAGUES_LIST = [
  { icon: "🥉", name: "Division III",       sub: "مفتوح للجميع",   color: "#cd7f32" },
  { icon: "🥈", name: "Division II",        sub: "متقدم",           color: "#94a3b8" },
  { icon: "🥇", name: "Professional",       sub: "محترف",           color: "#ffd700" },
  { icon: "👑", name: "Champions League",   sub: "النخبة فقط",      color: "#a78bfa" },
];
...
export default function CinematicIntro() {
  ...
  useEffect(() => {
    ...
    // ── Navigate to league select (9800ms) ──────────────────────────────
    at(() => { setStage("done"); go("/league-select"); }, 9800);
  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        onClick={() => { timers.current.forEach(clearTimeout); go("/league-select"); }}
