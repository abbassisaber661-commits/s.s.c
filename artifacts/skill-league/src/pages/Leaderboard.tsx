...
import { ArrowLeft, Trophy, RefreshCw, Loader2, Medal } from "lucide-react";
...
export default function Leaderboard() {
  ...
  useEffect(() => {
    const id = setInterval(() => load(selected), 60_000);
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <div className="text-[10px]" style={{ color: "rgba(255,255,255,0.35)" }}>
              {div.slotCount} مقعد · الموسم الحالي
            </div>
          </div>
        </div>
      ...
      <AnimatePresence>
        {playerRank !== null && !loading && (
          <motion.div
            ...
            style={{
              background: `rgba(${div.rgb},0.1)`,
              border: `1px solid rgba(${div.rgb},0.35)`,
            }}
          >
        ...
        {!loading && !error && entries.length === 0 && (
          <div className="flex flex-col items-center justify-center gap-3 py-20">
            ...
            <p className="text-sm text-center" style={{ color: "rgba(255,255,255,0.4)" }}>
              لا يوجد لاعبون في {div.label} بعد
            </p>
            <Link href="/league-select">
              <Button variant="outline" size="sm">ابدأ اللعب</Button>
            </Link>
          </div>
        )}
              ...
              return (
                ...
                >
                    ...
                    <div className="flex items-center gap-1 flex-wrap">
                      ...
                      {isBot && (
                        <span
                          ...
                          style={{ background: "rgba(74,222,128,0.12)", color: "rgba(74,222,128,0.7)", border: "1px solid rgba(74,222,128,0.25)" }}
                        >
                          🤖 Bot
                        </span>
                      )}
                  ...
                  <div className="text-right shrink-0">
                    <div className="text-sm font-black tabular-nums" style={{ color: div.color }}>
                      {entry.points}
                    </div>
