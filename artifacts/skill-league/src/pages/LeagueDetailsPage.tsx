...
const LEAGUE_INFO: Record<string, {
  ...
  "division-iii": {
    ...
    rewards: "الفوز يمنحك نقاط XP وLP. أداء استثنائي يفتح صناديق المكافآت اليومية ومكافآت Pi نهاية الموسم.",
  },
  "division-ii": {
    ...
    rewards: "مكافآت أعلى من Division III. الفوز يمنح مكافآت DN$ مضاعفة. 2 Pi لأفضل لاعب بنهاية الموسم.",
  },
  "professional": {
    ...
    rewards: "مكافآت ممتازة تشمل Pi حصرية (3 Pi للأول) وشارات احترافية وبطولات أسبوعية.",
  },
  "champions": {
    ...
    rewards: "أعلى مكافآت في اللعبة. 4 Pi للأول · 3 للثاني · 2 للثالث · 1 للرابع. لقب بطل الموسم.",
  },
};
