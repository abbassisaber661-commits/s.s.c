  ...
  const posts: CommunityPost[] = [
    {
      ...
      content: '🏆 Just won an 8-player tournament! The final round was so intense. GGs everyone!',
      type: 'text', timestamp: now - 12 * 60_000, likes: 14, boosted: true,
      boostExpiry: now + 10 * 3600_000, likedByMe: false,
    },
    {
      id: 'seed_2', authorName: 'NeonArrow42', authorLevel: 28, authorFame: 430,
      content: '⚔️ On a 7-game PvP win streak right now. Who dares to challenge me? 😈',
      type: 'text', timestamp: now - 40 * 60_000, likes: 8, boosted: false,
      boostExpiry: null, likedByMe: false,
    },
    {
      id: 'seed_3', authorName: 'SwiftHawk99', authorLevel: 52, authorFame: 1240,
      content: '💎 Just hit Level 50! Halfway Hero status. This game is genuinely addictive 🔥',
      type: 'text', timestamp: now - 2 * 3600_000, likes: 22, boosted: false,
      boostExpiry: null, likedByMe: false,
    },
    {
      id: 'seed_4', authorName: 'IronMind55', authorLevel: 15, authorFame: 110,
      content: '🎯 98% accuracy in a Bronze match today. Memory mode is hard but I\'m getting the hang of it!',
      type: 'text', timestamp: now - 5 * 3600_000, likes: 5, boosted: false,
      boostExpiry: null, likedByMe: false,
    },
    {
