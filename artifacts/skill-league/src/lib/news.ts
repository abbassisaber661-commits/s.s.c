...
export const NEWS_ITEMS: NewsItem[] = [
  ...
  },
  {
    ...
    body: 'The biggest tournament in SkillLeague history is here! Register now to compete for the Champion title, 10,000 DN$, and the exclusive Legendary Frame. Top 100 players all receive rewards!',
    bodyAr: 'أكبر بطولة في تاريخ SkillLeague هنا! سجّل الآن للتنافس على لقب البطل و10,000 DN$ والإطار الأسطوري الحصري. أفضل 100 لاعب يحصلون جميعاً على مكافآت!',
    icon: '🌍',
    type: 'event',
  ...
  },
  {
    ...
    body: 'SkillLeague will undergo brief maintenance this weekend for performance improvements. Downtime expected: 2 hours. All players will receive 50 bonus DN$ as compensation.',
    bodyAr: 'سيخضع SkillLeague لصيانة مختصرة هذا الأسبوع لتحسينات الأداء. وقت التوقف المتوقع: ساعتان. سيحصل جميع اللاعبين على 50 DN$ إضافية كتعويض.',
    icon: '🔧',
    type: 'maintenance',
